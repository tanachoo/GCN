...
# --node ./processed_data/target0_20190425/dataset_node.csv --cv 0 --scorerank 15000 --output ./pool_result/target0_20190425/score.txt
...
def sort_prediction_score(filename,cv,target_label_pairs,test_label_pairs,scorerank,train):
    ...
    print('\nSort scores and Pick top 3000000...')
    row_col_CHEBI_deleted.sort(reverse=True) # Sort list based on "score" with a decending order
    score_sort=row_col_CHEBI_deleted[:3000000] # Cut top list using arbitrary threshold
